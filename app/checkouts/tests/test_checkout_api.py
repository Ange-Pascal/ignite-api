...
class CheckoutAPITests(APITestCase):
    ...
    def setUp(self):
        ...
        self.cart.total_amount = self.course.price
        self.cart.save()

        # URL
        self.url_list = reverse("checkout-list")

    # ✅ Authenticated user can checkout his own cart
